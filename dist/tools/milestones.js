...
export async function handleMilestoneTool(name, args) {
    switch (name) {
      ...
      `, { id: args.contract_id });
            ...
            return terms.flatMap((t) => t.milestones || []);
        }
      ...
      `, {
                input: {
                    ...
                    depositAmount: dollarsToCents(args.amount),
                    ...(args.due_date ? { dueDate: args.due_date } : {}),
                    ...(args.instructions ? { instruction: args.instructions } : {}),
                },
            });
            return data.createMilestoneV2;
        }
        case "update_milestone": {
            const input = { id: args.milestone_id };
            if (args.description !== undefined)
                input.description = args.description;
            if (args.amount !== undefined)
                input.depositAmount = dollarsToCents(args.amount);
            if (args.due_date !== undefined)
                input.dueDate = args.due_date;
      ...
      `, { input: { id: args.milestone_id, ...(args.message ? { message: args.message } : {}) } });
      ...
      `, {
                input: {
                    ...
                    paidAmount: dollarsToCents(args.paid_amount),
                    ...(args.bonus_amount ? { bonusAmount: dollarsToCents(args.bonus_amount) } : {}),
                    ...(args.note_to_contractor ? { noteToContractor: args.note_to_contractor } : {}),
                    ...(args.payment_comment ? { paymentComment: args.payment_comment } : {}),
                },
            });
      ...
      `, { input: { id: args.milestone_id, noteToContractor: args.note_to_contractor } });
